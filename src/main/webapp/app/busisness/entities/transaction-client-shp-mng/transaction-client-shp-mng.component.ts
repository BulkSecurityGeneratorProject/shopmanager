...
@Component({
    selector: 'jhi-transaction-shp-mng',
    templateUrl: './transaction-client-shp-mng.component.html'
})
export class TransactionClientShpMngComponent implements OnInit, OnDestroy {

    transactions: TransactionClientShpMng[];
    currentAccount: any;
    ...
    trackId(index: number, item: TransactionClientShpMng) {
        return item.id;
    }
