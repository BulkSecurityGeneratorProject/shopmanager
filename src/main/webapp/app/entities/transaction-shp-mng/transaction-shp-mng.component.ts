...
@Component({
    ...
    templateUrl: './transaction-shp-mng.component.html'
})
export class TransactionShpMngComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: TransactionShpMng) {
        return item.id;
    }
