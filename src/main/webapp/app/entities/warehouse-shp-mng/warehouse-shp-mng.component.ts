...
@Component({
    selector: 'jhi-warehouse-shp-mng',
    templateUrl: './warehouse-shp-mng.component.html'
})
export class WarehouseShpMngComponent implements OnInit, OnDestroy {

currentAccount: any;
    warehouses: WarehouseShpMng[];
    error: any;
    success: any;
    ...
    transition() {
        this.router.navigate(['/warehouse-shp-mng'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: WarehouseShpMng) {
        return item.id;
    }
