...
describe('Service Tests', () => {
    ...
    describe('TransactionTagShpMng Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TransactionTagShpMngService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/transaction-tags/' + 123);
            });
            it('should return TransactionTagShpMng', () => {

                let entity: TransactionTagShpMng;
                service.find(123).subscribe((_entity: TransactionTagShpMng) => {
                    entity = _entity;
                });
