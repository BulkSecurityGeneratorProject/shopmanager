...
describe('Service Tests', () => {
    ...
    describe('WarehouseShpMng Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(WarehouseShpMngService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/warehouses/' + 123);
            });
            it('should return WarehouseShpMng', () => {

                let entity: WarehouseShpMng;
                service.find(123).subscribe((_entity: WarehouseShpMng) => {
                    entity = _entity;
                });
