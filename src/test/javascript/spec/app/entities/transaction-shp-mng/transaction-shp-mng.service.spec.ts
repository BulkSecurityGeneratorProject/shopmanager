...
describe('Service Tests', () => {
    ...
    describe('TransactionShpMng Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TransactionShpMngService);
        ...
        describe('Service methods', () => {
            ...
            it('should return TransactionShpMng', () => {

                let entity: TransactionShpMng;
                service.find(123).subscribe((_entity: TransactionShpMng) => {
                    entity = _entity;
                });
