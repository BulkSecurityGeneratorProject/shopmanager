...
describe('Service Tests', () => {
    ...
    describe('ProductShpMng Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProductShpMngService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ProductShpMng', () => {

                let entity: ProductShpMng;
                service.find(123).subscribe((_entity: ProductShpMng) => {
                    entity = _entity;
                });
